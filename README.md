...
<img src="https://github.com/mostafiz67/Regression_EC_Real_World_Data/blob/master/accuracy_vs_ec_plots/new_medical_plots/MAE_House_only.png" alt="MAE VS Regression EC (House Dataset)" width="800" height="500">
<p align="center">
    Figure: MAE VS Regression EC (House Dataset)
</p>

<img src="https://github.com/mostafiz67/Regression_EC_Real_World_Data/blob/master/accuracy_vs_ec_plots/new_medical_plots/MAE_Diabetics_only.png" alt="MAE VS Regression EC (Diabetics Dataset)" width="800" height="500">
<p align="center">
